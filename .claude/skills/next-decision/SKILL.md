...
name: next-decision
description: >
  Drill open decisions one at a time — present the most important unresolved decision,
  give the top four choices, state a preference, ask the user. Use when the user says
  "next decision", "one decision at a time", or a plan has several unresolved choices.
  Differentiator: forward-looking; the decisions skill is retrospective.

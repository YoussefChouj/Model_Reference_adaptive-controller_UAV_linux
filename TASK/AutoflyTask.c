...
#define SDK_Cmd_Pos6           20  //开环4
#define SDK_Cmd_Pos7           21  //开环4
#define SDK_Cmd_Pos8           22  //开环4
#define SDK_Cmd_Pos9           23  //开环4
#define SDK_Cmd_Pos10          24  //开环4
#define  SDK_Cmd_go_to_land    25  //开环4
#define V_max `10
